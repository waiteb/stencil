...
describe("A stencil", function() {
    ...
    describe("has custom attributes that", function() {
        ...
        it("can be defined", function() {
            ...
            stencil.addAttributes({test: testAttribute});

            expect(stencil.attributes["test-add-attribute"]).to.equal(testAttribute);
        });
        ...
        it("must be excplicitly shown", function() {
            ...
            stencil.addAttributes({
                shownAttribute: {name: "shown", show: true}
            });
        ...
        it("can override element rendering", function() {
            ...
            stencil.addAttributes({
                overiddenAttribute: {name: "override", onRender: function() {return "overidden";}}
            });
        ...
        it("use expression values by default", function() {
            ...
            stencil.addAttributes({
                testExpression: {name: "test-expression", show: true}
            });
