...
describe("A stencil", function() {
    ...
    describe("can render", function() {
        ...
        it("conditionally renders binary expressions", function() {
            ...
            var stencil = new Stencil("{{a for b}}"),
                output;

            stencil.addExpressions({
                arrow:  {
    ...
    describe("has custom attributes that", function() {
        ...
        it("can be defined", function() {
            var stencil = new Stencil("<p/>"),
                firstAttribute = {onRender: function() {}},
                secondAttribute = {onRender: function() {}};

            // Added values should be available in the stencil:
            stencil.addAttributes({firstAttribute: firstAttribute});
            expect(stencil.attributes.firstAttribute).to.equal(firstAttribute);

            // New values should be added to the collection:            
            stencil.addAttributes({secondAttribute: secondAttribute});
            expect(stencil.attributes.firstAttribute).to.equal(firstAttribute);
            expect(stencil.attributes.secondAttribute).to.equal(secondAttribute);
        });
