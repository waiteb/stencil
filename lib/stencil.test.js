...
describe("A stencil", function() {
    ...
    it("can include substencils that are uncompiled HTML", function() {
        ...
        // The substencil should be compiled, and it should have the same settings as the root stencil:
    ...
    it("can include substencils as a batch", function() {
        ...
        // Both substencils should have been included:
        expect(rootStencil.substencils.alpha.document.nodeType).to.equal(Stencil.NodeType.DOCUMENT);
        expect(rootStencil.substencils.beta).to.equal(substencil);
    });
    ...
    describe("has expressions that", function() {
        ...
        it("can be defined", function() {
            ...
            Stencil.addExpression(expression);

            expect(Stencil.expression["TestExpression(operator)"]).to.equal(expression);
        });
    });
