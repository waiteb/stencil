...
describe("stencil", function() {
    ...
    it("compiles expressions in text nodes recursively", function() {
        ...
        p2 = stencil.document.childNodes[1].childNodes[0];

        // The text of the P tag should have been broken into three pieces:
        expect(p1.nodeType).to.equal(Stencil.NodeType.EXPRESSION);
        expect(p2.nodeType).to.equal(Stencil.NodeType.EXPRESSION);
    });


    it("compiles expressions in attributes", function() {
    ...
    it("renders compund text nodes", function() {
    ...
    it("renders compound expression attributes", function() {
