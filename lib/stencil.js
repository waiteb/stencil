...
Stencil.prototype.render = function(model, node) {
    ...
    var scratchpad = scratchpad || new Scratchpad(node, Object.assign({}, this.globals, {model: model}));
    
    return this.renderChildren(model, node, scratchpad);
};
 ...
 * @return {string} The rendered HTML
 */
Stencil.prototype.renderChildren = function(model, node, scratchpad) {
    ...
    nodes.forEach(function(node) {
        ...
        switch (node.nodeType) {
            ...
            case Stencil.NodeType.DOCUMENT: {
                output += this.renderChildren(model, node, scratchpad);
                break;
            }
...
Stencil.prototype.renderElement = function(model, node, scratchpad) {
    ...
    if (output === undefined) {
        ...
        let children = this.renderChildren(model, node, scratchpad);
