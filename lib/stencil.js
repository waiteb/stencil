...
Stencil.addExpression = function(type, operator, strategy) {
    ...
    Stencil.expression[key] = strategy;
};
    ...
    nodes.forEach(function(node) {
        ...
        switch (node.nodeType) {
            ...
            case Stencil.NodeType.EXPRESSION: {
                output += this.renderExpression(model, node.expression);
                break;
            }
        }
