...
describe("scratchpad", function() {
    ...
    it("can be constructed with default root scope properties", function() {

        var scratchpad = new Scratchpad({}, {alpha: "value"});

        expect(scratchpad.scope.alpha).to.equal("value");
    });
    ...
    it("has follows an api", function() {
        ...
        expect(scratchpad.root).to.be.an("object");
    ...
    it("can store values in the current element", function() {
        ...
        expect(scratchpad.element).to.deep.equal({});
