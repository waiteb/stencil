...
describe("stencil element", function() {
    ...
    describe("stencil", function() {
        ...
        it("maintains proper scope when rendering substencils", function() {
            ...
            // NOTE:
            // As we render these subtemplates, multiple states get 
            // added to the scratchpad stack.  One for the stencil tag,
            // and one for the substencil that takes its place.  At this
            // point, the substencils are too deep in the stack.
            
            // This test proves that we've corrected for this in the
            // stencil element.
