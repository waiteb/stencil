...
describe("stencil expressions", function() {
    ...
    describe("can render", function() {
        ...
        it("function identifiers as WRAPPED OBJECTS", function() {

            var html = "{{method.isMethod}}-{{method.context.value}}-{{method}}",
                stencil = new Stencil(html),
                output = stencil.render({
                    method: function() {},
                    value: "alpha"
            ...
            expect(output).to.equal("true-alpha-");
        });
        
        
        it("function members as WRAPPED OBJECTS", function() {

            var html = "{{context.method.isMethod}}-{{context.method.context.value}}-{{context.method}}",
                stencil = new Stencil(html),
                output = stencil.render({
                    context: {
                        method: function() {},
        ...
        xit("FILTER expressions can inherit filters from parent stencils", function(){});
    });
});