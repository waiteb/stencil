...
scopePlugin.onRenderAttribute = function(attribute, model, node, stencil, scratchpad) {
    scratchpad.model = attribute.value;
};


var ifPlugin = new Plugin("if");
ifPlugin.onRenderAttribute =  function(attribute, model, node, stencil, scratchpad) {
...
elseIfPlugin.onRenderAttribute =  function(attribute, model, node, stencil, scratchpad) {
...
elsePlugin.onRenderAttribute = function(attribute, model, node, stencil, scratchpad) {
...
eachPlugin.onRenderAttribute = function(attribute, model, node, stencil, scratchpad) {
