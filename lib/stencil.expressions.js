...
module.exports = {
    ...
    identifier: {
        ...
        onRender: function(model, expression, stencil) {
            ...
            var result = model && model[expression.name];

            // If the result is a function, wrap it up so
            // we can preserve the context:
            if (typeof result === "function") {
                result = new StencilMethod(model, result);
            }
    ...
    member: {
        ...
        onRender: function(model, expression, stencil, scratchpad) {
            ...
            if (typeof output === "function") {
                output = new StencilMethod(object, output);
            }
